...
>
  ...
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
          ...
          <p className="text-xs sm:text-base text-gray-500 mt-1 items-center">
  ...
  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleOptionClick("10-50-lakh")}>10 - 50 Lakh</li>
  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleOptionClick("50-lakh-1cr")}>50 Lakh - 1 Cr</li>
  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleOptionClick("1cr-3cr")}>1 Cr - 3 Cr</li>
  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleOptionClick("5cr+")}>5 Cr+</li>
</ul>
  ...
  >
    ...
    <div className="absolute inset-x-0 bottom-0 h-1/4  bg-[#011b25bd] transition-all duration-300 flex flex-col justify-end text-white px-3 sm:px-4 pb-1 sm:pb-4">
      ...
      <p className="text-xs sm:text-sm text-gray-200">Market Price : {property.marketPrice || "Loading..."}</p>
      <p className="text-xs sm:text-sm  text-red-600 cursor-pointer font-semibold underline "  onClick={(e) => {
          e.stopPropagation();
          navigate('/view_auction');
        }}>Explore Nearby Projects</p>
      <button
         onClick={() => {
