...
import { LogOut, User, Shield, Star, Search, Heart } from 'lucide-react';

export default function ViewProfile() {
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <div className="w-64 bg-white border-r shadow-sm p-4 flex flex-col justify-between">
        <div>
      ...
      <div className="flex-1 p-8">
        <div className="max-w-xl mx-auto bg-white shadow-sm rounded-md p-6">
          {/* Profile Picture */}
